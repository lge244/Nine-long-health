...
class Notice_EweiShopV2Model 
{
	...
	public function sendOrderMessage($orderid = '0', $delRefund = false, $raid = NULL) 
	{
		...
		$datas = array( 0 => array('name' => '商城名称', 'value' => $_W['shopset']['shop']['name']), 1 => array('name' => '粉丝昵称', 'value' => $member['nickname']), 2 => array('name' => '订单号', 'value' => $order['ordersn']), 3 => array('name' => '订单编号', 'value' => $order['ordersn']), 4 => array('name' => '订单金额', 'value' => $order['price']), 5 => array('name' => '运费', 'value' => $order['dispatchprice']), 6 => array('name' => '商品详情', 'value' => $goods), 7 => array('name' => '快递公司', 'value' => $order['expresscom']), 8 => array('name' => '快递单号', 'value' => $order['expresssn']), 9 => array('name' => '购买者姓名', 'value' => $buyerinfo_name), 10 => array('name' => '购买者电话', 'value' => $buyerinfo_mobile), 11 => array('name' => '收货地址', 'value' => $addressinfo), 12 => array('name' => '下单时间', 'value' => date('Y-m-d H:i', $order['createtime'])), '支付时间' => array('name' => '支付时间', 'value' => date('Y-m-d H:i', $order['paytime'])), 13 => array('name' => '发货时间', 'value' => date('Y-m-d H:i', $order['sendtime'])), 14 => array('name' => '收货时间', 'value' => date('Y-m-d H:i', $order['finishtime'])), 15 => array('name' => '取消时间', 'value' => date('Y-m-d H:i', $order['canceltime'])), 16 => array('name' => '门店', 'value' => (!(empty($store)) ? $store['storename'] : '')), 17 => array('name' => '门店地址', 'value' => (!(empty($store)) ? $store['address'] : '')), 18 => array('name' => '门店联系人', 'value' => (!(empty($store)) ? $store['realname'] . '/' . $store['mobile'] : '')), 19 => array('name' => '门店营业时间', 'value' => (!(empty($store)) ? ((empty($store['saletime']) ? '全天' : $store['saletime'])) : '')), 20 => array('name' => '虚拟物品自动发货内容', 'value' => $order['virtualsend_info']), 21 => array('name' => '虚拟卡密自动发货内容', 'value' => $order['virtual_str']), 22 => array('name' => '自提码', 'value' => $order['verifycode']), 23 => array('name' => '备注信息', 'value' => $order['remark']), 24 => array('name' => '商品数量', 'value' => $goodsnum), 25 => array('name' => '商品名称', 'value' => $goodsname) );
		$usernotice = unserialize($member['noticeset']);
		if (!(is_array($usernotice))) 
		{
			$usernotice = array();
		...
		if ($delRefund) 
		{
			...
			if (!(empty($order['refundid']))) 
			{
				...
				if ($refund['status'] == 0) 
				{
					...
					else if (!(empty($merch_tm)) && empty($merch_tm['saler_refund_close_advanced'])) 
					{
						$is_send = 1;
						$tm['openid'] = $merch_tm['openid'];
					}
					if (!(empty($is_send))) 
					{
						...
						$msg = array( 'first' => array('value' => '您有订单于' . date('Y-m-d H:i', $order['paytime']) . '申请维权！！' . "\n" . '请登录后台查看维权详情。', 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => $r_type[$refund['rtype']] . '申请', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '维权申请通知', 'color' => '#4b9528'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => $remark2, 'color' => '#000000') );
						if ($order['paytype'] == 3) 
						{
							$text = '您有一条维权订单信息！！' . "\n" . '请及时处理。' . "\n\n" . '订单号：' . "\n" . '[订单号]' . "\n" . '订单金额：[订单金额]' . "\n" . '---------------------' . "\n" . '购买商品信息：[商品详情]' . "\n" . '备注信息：[备注信息]' . "\n" . '---------------------' . "\n" . '收货人：[购买者姓名]' . "\n" . '收货人电话:[购买者电话]' . "\n" . '收货地址:[收货地址]' . "\n\n" . '请及时处理';
						}
				...
				else if ($refund['status'] == 3) 
				{
					if (($refund['rtype'] == 2) || ($refund['rtype'] == 1)) 
					{
						...
						$msg = array( 'first' => array('value' => '您好，您的退换货申请已经通过，请您及时发送快递。' . "\n", 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '退换货申请', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '退换货通过', 'color' => '#4b9528'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => $remark2, 'color' => '#000000') );
				...
				else if ($refund['status'] == -1) 
				{
					...
					$msg = array( 'first' => array('value' => '您好，你有一笔' . $r_type[$refund['rtype']] . '被驳回，您可以与我们取得联系！' . "\n", 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '退换货申请', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '驳回通知', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => $remark2, 'color' => '#000000') );
			...
			foreach ($order_goods as $og ) 
			{
				if (!(empty($og['noticeopenid'])) && !(empty($og['noticetype']))) 
				{
					...
					if (($og['noticetype'] == '1') || (is_array($noticetype) && in_array('1', $noticetype))) 
					{
						...
						$msg = array( 'first' => array('value' => '您有新的货到付款订单于' . date('Y-m-d H:i', $order['createtime']) . '已下单！！' . "\n" . '请登录后台查看详情并及时安排发货。' . "\n", 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '商品付款通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '已付款', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => $remark, 'color' => '#000000') );
			...
			else 
			{
				if (($order['status'] == 2) || (($order['status'] == 1) && !(empty($order['sendtype'])))) 
				{
					...
					if ($isonlyverify) 
					{
						if (empty($usernotice['pay'])) 
						{
							...
							$msg = array( 'first' => array('value' => '您的记次时商品订单已于' . date('Y-m-d H:i', $order['paytime']) . '成功支付！' . "\n", 'color' => '#4b9528'), 'keyword1' => array('title' => '订单编号', 'value' => $order['ordersn'], 'color' => '#000000'), 'keyword2' => array('title' => '商品名称', 'value' => substr_replace($goodsname, "\n", strrpos($goodsname, "\n\n"), strlen("\n\n")), 'color' => '#000000'), 'keyword3' => array('title' => '商品数量', 'value' => $goodsnum, 'color' => '#000000'), 'keyword4' => array('title' => '支付金额', 'value' => $order['price'], 'color' => '#000000'), 'remark' => array('value' => $remark, 'color' => '#000000') );
							$this->sendNotice(array('openid' => $openid, 'tag' => 'pay', 'default' => $msg, 'cusdefault' => $text, 'url' => $url, 'datas' => $datas, 'appurl' => $appurl));
							com_run('sms::callsms', array('tag' => 'pay', 'datas' => $datas, 'mobile' => (!(empty($buyerinfo_mobile)) && $order['isverify'] ? $buyerinfo_mobile : $member['mobile'])));
							if (p('app') && !(empty($order['wxapp_prepay_id']))) 
							{
				...
				else if ($order['status'] == 3) 
				{
					...
					if ($pv && !(empty($order['virtual']))) 
					{
						...
						if (!(empty($is_send))) 
						{
							$msg = array( 'first' => array('value' => $first, 'color' => '#4b9528'), 'keyword2' => array('title' => '业务状态', 'value' => '订单收货通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '虚拟物品及卡密自动发货', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('title' => '', 'value' => $remark, 'color' => '#000000') );
							$account = m('common')->getAccount();
							if (!(empty($tm['openid2']))) 
							{
					...
					else if ($order['isvirtualsend']) 
					{
						...
						if (!(empty($is_send))) 
						{
							$msg = array( 'first' => array('value' => $first, 'color' => '#4b9528'), 'keyword2' => array('title' => '业务状态', 'value' => '订单收货通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '商品自动发货', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('title' => '', 'value' => $remark, 'color' => '#000000') );
							$account = m('common')->getAccount();
							if (!(empty($tm['openid2']))) 
							{
								$openids = explode(',', $tm['openid2']);
					...
					else 
					{
						...
						if (!(empty($is_send))) 
						{
							$msg = array( 'first' => array('value' => $first, 'color' => '#4b9528'), 'keyword2' => array('title' => '业务状态', 'value' => '订单收货通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '商品确认收货', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('title' => '', 'value' => $remark, 'color' => '#000000') );
							$account = m('common')->getAccount();
							if (!(empty($tm['openid2']))) 
							{
								$openids = explode(',', $tm['openid2']);
	...
	public function sendMemberUpgradeMessage($openid = '', $oldlevel = NULL, $level = NULL) 
	{
		...
		$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您成功升级！' . "\n", 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '会员升级', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您会员等级从 ' . $oldlevelname . ' 升级为 ' . $level['levelname'] . ', 特此通知!', 'color' => '#000000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '您即可享有' . $level['levelname'] . '的专属优惠及服务！', 'color' => '#000000') );
	...
	public function sendStockWarnMessage($goodsid, $optionid) 
	{
		...
		if (!(empty($is_send))) 
		{
			...
			$msg = array( 'first' => array('value' => '您的商品库存已经不足' . $stockwarn . '，请及时补货！' . "\n", 'color' => '#ff0000'), 'keyword2' => array('title' => '业务状态', 'value' => '商品库存不足', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '请及时补货', 'color' => '#4b9528'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'remark' => array('value' => '商品名称：' . $goodtitle, 'color' => '#000000') );
			if (!(empty($tm['openid3']))) 
			{
