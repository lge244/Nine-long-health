...
class Selecturl_EweiShopV2Page extends WebPage 
{
	...
	public function main() 
	{
		...
		$allUrls = array( array( 'name' => '商城页面', 'list' => array( array('name' => '商城首页', 'url' => mobileUrl(NULL, NULL, $full), 'url_wxapp' => '/pages/index/index'), array('name' => '分类导航', 'url' => mobileUrl('shop/category', NULL, $full), 'url_wxapp' => '/pages/shop/caregory/index'), array('name' => '全部商品', 'url' => mobileUrl('goods', NULL, $full), 'url_wxapp' => '/pages/goods/index/index'), array('name' => '公告页面', 'url' => mobileUrl('shop/notice', NULL, $full), 'url_wxapp' => '/pages/shop/notice/index/index'), array('name' => '购物车', 'url' => mobileUrl('member/cart', NULL, $full), 'url_wxapp' => '/pages/member/cart/index') ) ), array( 'name' => '商品属性', 'list' => array( array('name' => '推荐商品', 'url' => mobileUrl('goods', array('isrecommand' => 1), $full), 'url_wxapp' => '/pages/goods/index/index?isrecommand=1'), array('name' => '新品上市', 'url' => mobileUrl('goods', array('isnew' => 1), $full), 'url_wxapp' => '/pages/goods/index/index?isnew=1'), array('name' => '热卖商品', 'url' => mobileUrl('goods', array('ishot' => 1), $full), 'url_wxapp' => '/pages/goods/index/index?ishot=1'), array('name' => '促销商品', 'url' => mobileUrl('goods', array('isdiscount' => 1), $full), 'url_wxapp' => '/pages/goods/index/index?isdiscount=1'), array('name' => '卖家包邮', 'url' => mobileUrl('goods', array('issendfree' => 1), $full), 'url_wxapp' => '/pages/goods/index/index?issendfree=1'), array('name' => '限时抢购', 'url' => mobileUrl('goods', array('istime' => 1), $full), 'url_wxapp' => '/pages/goods/index/index?istime=1') ) ), array( 'name' => '会员中心', 'list' => array( 0 => array('name' => '会员中心', 'url' => mobileUrl('member', NULL, $full), 'url_wxapp' => '/pages/member/index/index'), 1 => array('name' => '我的订单(全部)', 'url' => mobileUrl('order', NULL, $full), 'url_wxapp' => '/pages/order/index'), 2 => array('name' => '待付款订单', 'url' => mobileUrl('order', array('status' => 0), $full), 'url_wxapp' => '/pages/order/index?status=0'), 3 => array('name' => '待发货订单', 'url' => mobileUrl('order', array('status' => 1), $full), 'url_wxapp' => '/pages/order/index?status=1'), 4 => array('name' => '待收货订单', 'url' => mobileUrl('order', array('status' => 2), $full), 'url_wxapp' => '/pages/order/index?status=2'), 5 => array('name' => '退换货订单', 'url' => mobileUrl('order', array('status' => 4), $full), 'url_wxapp' => '/pages/order/index?status=4'), 6 => array('name' => '已完成订单', 'url' => mobileUrl('order', array('status' => 3), $full), 'url_wxapp' => '/pages/order/index?status=3'), 7 => array('name' => '我的收藏', 'url' => mobileUrl('member/favorite', array(), $full), 'url_wxapp' => '/pages/member/favorite/index'), 8 => array('name' => '我的足迹', 'url' => mobileUrl('member/history', array(), $full), 'url_wxapp' => '/pages/member/history/index'), 9 => array('name' => '会员充值', 'url' => mobileUrl('member/recharge', array(), $full), 'url_wxapp' => '/pages/member/recharge/index'), 10 => array('name' => '余额明细', 'url' => mobileUrl('member/log', array(), $full), 'url_wxapp' => '/pages/member/log/index'), 11 => array('name' => '余额提现', 'url' => mobileUrl('member/withdraw', array(), $full), 'url_wxapp' => '/pages/member/withdraw/index'), 12 => array('name' => '我的资料', 'url' => mobileUrl('member/info', array(), $full), 'url_wxapp' => '/pages/member/info/index'), 13 => array('name' => '积分排行', 'url' => mobileUrl('member/rank', array(), $full), 'url_wxapp' => ''), 14 => array('name' => '消费排行', 'url' => mobileUrl('member/rank/order_rank', array(), $full), 'url_wxapp' => ''), 16 => array('name' => '收货地址管理', 'url' => mobileUrl('member/address', array(), $full), 'url_wxapp' => '/pages/member/address/index'), 18 => array('name' => '我的全返', 'url' => mobileUrl('member/fullback', array(), $full), 'url_wxapp' => ''), 19 => array('name' => '记次时商品', 'url' => mobileUrl('verifygoods', array(), $full), 'url_wxapp' => '') ) ) );
		if ($platform) 
		{
