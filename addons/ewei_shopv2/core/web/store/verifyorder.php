...
class Verifyorder_EweiShopV2Page extends WebPage
{
    protected function orderData()
    {
        ...
        $paytype = array( 1 => array( "css" => "danger", "name" => "余额支付" ), 11 => array( "css" => "default", "name" => "后台付款" ), array( "css" => "danger", "name" => "在线支付" ), 21 => array( "css" => "success", "name" => "微信支付" ), 22 => array( "css" => "warning", "name" => "支付宝支付" ), 23 => array( "css" => "warning", "name" => "银联支付" ), 3 => array( "css" => "primary", "name" => "货到付款" ) );
        ...
        if( $_GPC["export"] == 1 ) 
        {
            ...
            foreach( $list as &$row ) 
            {
                ...
                if( $row["isverify"] && is_array($verifyinfo) && empty($row["dispatchtype"]) ) 
                {
                    $v = $verifyinfo[0];
