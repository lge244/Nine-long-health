...
class Printer_EweiShopV2ComModel extends ComModel {
	...
	public function printer_list() {
		return array(self::PRINTRT_365 => '365云打印(编号kdt2)', self::PRINTRT_FEIE => '飞鹅打印机', self::PRINTRT_YILIANYUN => '易联云打印机', self::PRINTRT_365_S1 => '365云打印(编号kdt1)');
	}
	...
	protected function replace($params = array(), $template = '') {
		...
		switch ($this->type) {
			case 1:
				$datas = array();
			break;
				$datas = array('[商品名称]' => (isset($params['shorttitle']) ? $params['shorttitle'] : ''), '[商品价格]' => (isset($params['goodsprice']) ? $params['goodsprice'] : ''), '[商品数量]' => (isset($params['goodstotal']) ? $params['goodstotal'] : ''), '[单商品合计]' => (isset($params['goodstotalprice']) ? $params['goodstotalprice'] : ''), '[订单编号]' => (isset($params['ordersn']) ? $params['ordersn'] : ''), '[订单金额]' => (isset($params['price']) ? $params['price'] : ''), '[优惠金额]' => (isset($params['discount']) ? $params['discount'] : ''), '[收货人]' => (isset($params['realname']) ? $params['realname'] : ''), '[收货地址]' => (isset($params['address']) ? $params['address'] : ''), '[收货电话]' => (isset($params['mobile']) ? $params['mobile'] : ''), '[备注]' => (isset($params['remark']) ? $params['remark'] : ''), '[运费]' => (isset($params['dispatchprice']) ? $params['dispatchprice'] : ''), '[订单时间标题]' => (isset($params['order_time_title']) ? $params['order_time_title'] : ''), '[订单时间]' => (isset($params['order_time']) ? $params['order_time'] : ''), '[订单状态]' => (isset($params['order_status']) ? $params['order_status'] : ''), '[门店名称]' => (isset($params['storename']) ? $params['storename'] : ''), '[门店地址]' => (isset($params['storeaddress']) ? $params['storeaddress'] : ''), '[门店联系方式]' => (isset($params['storemobile']) ? $params['storemobile'] : ''), '[门店联系人]' => (isset($params['storerealname']) ? $params['storerealname'] : ''));
		}
	...
	public function sendOrderMessage($orderid = 0, $verify = array()) {
		...
		foreach ($order_goods as $og) {
			$goods[] = array('shorttitle' => (empty($og['shorttitle']) ? $og['title'] : $og['shorttitle']), 'goodsprice' => (double)$og['realprice'] / (int)$og['total'], 'goodstotal' => (int)$og['total'], 'goodstotalprice' => (double)$og['realprice'], 'optionname' => $og['optionname']);
		}
