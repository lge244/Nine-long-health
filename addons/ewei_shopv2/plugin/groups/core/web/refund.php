	...
	public function main() 
	{
		...
		try 
		{
			...
			if( $_GPC["export"] == 1 ) 
			{
				...
				$columns = array( array( "title" => "订单编号", "field" => "orderno", "width" => 24 ), array( "title" => "维权编号", "field" => "refundno", "width" => 24 ), array( "title" => "粉丝昵称", "field" => "nickname", "width" => 12 ), array( "title" => "会员姓名", "field" => "mrealname", "width" => 12 ), array( "title" => "openid", "field" => "openid", "width" => 30 ), array( "title" => "会员手机手机号", "field" => "mmobile", "width" => 15 ), array( "title" => "退货人姓名", "field" => "arealname", "width" => 15 ), array( "title" => "联系电话", "field" => "amobile", "width" => 12 ), array( "title" => "退货地址", "field" => "aprovince", "width" => 12 ), array( "title" => "", "field" => "acity", "width" => 12 ), array( "title" => "", "field" => "aarea", "width" => 12 ), array( "title" => "", "field" => "aaddress", "width" => 20 ), array( "title" => "商品名称", "field" => "title", "width" => 30 ), array( "title" => "商品编码", "field" => "goodssn", "width" => 15 ), array( "title" => "团购价", "field" => "groupsprice", "width" => 12 ), array( "title" => "单购价", "field" => "singleprice", "width" => 12 ), array( "title" => "原价", "field" => "price", "width" => 12 ), array( "title" => "商品数量", "field" => "goods_total", "width" => 15 ), array( "title" => "商品小计", "field" => "goodsprice", "width" => 12 ), array( "title" => "退还积分", "field" => "applycredit", "width" => 12 ), array( "title" => "退款金额", "field" => "applyprice", "width" => 12 ), array( "title" => "应收款", "field" => "amount", "width" => 12 ), array( "title" => "退款方式", "field" => "pay_type", "width" => 12 ), array( "title" => "状态", "field" => "status", "width" => 12 ), array( "title" => "申请退款时间", "field" => "applytime", "width" => 24 ), array( "title" => "取消申请退款时间", "field" => "refundtime", "width" => 24 ), array( "title" => "同意退换货申请时间", "field" => "operatetime", "width" => 24 ), array( "title" => "买家发货快递", "field" => "expresscom", "width" => 24 ), array( "title" => "买家发货快递单号", "field" => "expresssn", "width" => 24 ), array( "title" => "买家发货时间", "field" => "sendtime", "width" => 24 ), array( "title" => "卖家发货快递", "field" => "rexpresscom", "width" => 24 ), array( "title" => "卖家发货快递单号", "field" => "rexpresssn", "width" => 24 ), array( "title" => "卖家发货时间", "field" => "returntime", "width" => 24 ), array( "title" => "结束时间", "field" => "endtime", "width" => 24 ), array( "title" => "维权原因", "field" => "reason", "width" => 24 ), array( "title" => "维权说明", "field" => "content", "width" => 24 ), array( "title" => "订单备注", "field" => "remark", "width" => 36 ) );
				$exportlist = array( );
				foreach( $list as $key => $value ) 
				{
