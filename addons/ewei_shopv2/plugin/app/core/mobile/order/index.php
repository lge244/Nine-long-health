...
class Index_EweiShopV2Page extends AppMobilePage 
{
	...
	public function cycelbuy_list() 
	{
		...
		$result = array( "list" => $cycelData, "cycelUnderway" => $cycelUnderway["count"], "cycelbuy_periodic" => $orderData["cycelbuy_periodic"], "maxday" => $cycelbuy_set["max_day"], "notStart" => $notStart, "period_index" => $period_index, "orderid" => $orderData["id"], "applyid" => $applyid );
		app_json($result);
	}
