...
if (!(class_exists('DividendModel'))) 
{
	class DividendModel extends PluginModel 
	{
		...
		public function sendMessage($openid = '', $data = array(), $message_type = '') 
		{
			...
			if (($message_type == TM_DIVIDEND_ORDER_FINISH) && empty($usernotice['dividend_order_finish'])) 
			{
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['dividend_order_finishtitle'])) ? $tm['dividend_order_finishtitle'] : '下线确认收货通知'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
			...
			else if (($message_type == TM_DIVIDEND_APPLY) && empty($usernotice['dividend_apply'])) 
			{
				...
				$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['dividend'] . '提现申请已提交', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '提现申请提交通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现申请已提交', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
				$toopenid = $openid;
				$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
			...
			else if (($message_type == TM_DIVIDEND_CHECK) && empty($usernotice['dividend_check'])) 
			{
				...
				$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['dividend'] . '提现申请已审核通过', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '提现申请审核通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现申请审核完成', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
				$toopenid = $openid;
				$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
				$datas[] = array('name' => '时间', 'value' => $time);
				$datas[] = array('name' => '金额', 'value' => $data['dividend']);
			...
			else if (($message_type == TM_DIVIDEND_PAY) && empty($usernotice['dividend_pay'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['dividend1'] . '打款成功', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => $set['texts']['dividend1'] . '打款通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现已打款成功', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
					$datas[] = array('name' => '时间', 'value' => $time);
					$datas[] = array('name' => '金额', 'value' => $data['dividend']);
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['dividend_paytitle'])) ? $tm['dividend_paytitle'] : '佣金打款通知'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
			...
			else if (($message_type == TM_DIVIDEND_BECOME_SALER) && empty($usernotice['dividend_become_saler'])) 
			{
				...
				$message = array( 'first' => array('value' => '您的商城会员' . $member['nickname'] . $set['texts']['become'], 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '成为' . $set['texts']['agent'] . '通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '成为队长通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
				$datas[] = array('name' => '昵称', 'value' => $data['nickname']);
				$datas[] = array('name' => '时间', 'value' => date('Y-m-d H:i:s', $data['headstime']));
			}
			else if (($message_type == TM_DIVIDEND_APPLYMONEY) && empty($usernotice['dividend_applymoney'])) 
			{
				...
				$message = array( 'first' => array('value' => '亲爱的管理员您有一条新的' . $set['texts']['dividend'] . '提现申请', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '已提交', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的商城会员提交了一笔提现，' . "\n" . '金额:' . $data['dividend'] . ' ' . "\n" . ' 时间:' . $time . "\n" . ' 提现方式:' . $data['type'], 'color' => '#000000'), 'remark' => array('value' => "\n" . '请您注意审核团队分红的分红提现申请，及时处理哦', 'color' => '#000000') );
				$toopenid = $tm['openid'];
				$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
				$datas[] = array('name' => '时间', 'value' => $time);
				$datas[] = array('name' => '金额', 'value' => $data['dividend']);
			...
			else if (($message_type == TM_DIVIDEND_DOWNLINE_BECOME) && empty($usernotice['dividend_downline_become'])) 
			{
				...
				$message = array( 'first' => array('value' => '您的团员' . $member['nickname'] . '已成为队长', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '团员成为队长通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的团员在' . $time . '成为队长，他的下线不在为您提供分红', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
		...
		protected function replaceTemplate($str, $tag, $data, $member) 
		{
			...
			switch ($tag) 
			{
				case 'dividend_become_advanced': $arr['[时间]'] = date('Y-m-d H:i:s', $data['agenttime']);
				$arr['[下级昵称]'] = $data['nickname'];
				$arr['[昵称]'] = $data['nickname'];
				break;
				case 'dividend_agent_new_advanced': $arr['[时间]'] = date('Y-m-d H:i:s', $data['childtime']);
				$arr['[下级昵称]'] = $data['nickname'];
				$arr['[昵称]'] = $data['nickname'];
				break;
				case 'dividend_order_pay_advanced': $arr['[时间]'] = date('Y-m-d H:i:s', $data['paytime']);
				$arr['[下级昵称]'] = $data['nickname'];
				$arr['[昵称]'] = $data['nickname'];
				break;
				case 'dividend_order_finish_advanced': $arr['[时间]'] = date('Y-m-d H:i:s', $data['finishtime']);
				$arr['[下级昵称]'] = $data['nickname'];
				$arr['[昵称]'] = $data['nickname'];
				break;
			}
