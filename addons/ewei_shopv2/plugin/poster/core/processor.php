	...
	private function responseSubscribe($obj) 
	{
		...
		if (empty($log) && ($openid != $qr['openid'])) 
		{
			...
			if (!(empty($poster['subtext']))) 
			{
				...
				{
					m('message')->sendTplNotice($qr['openid'], $poster['templateid'], array( 'first' => array('value' => '推荐关注奖励到账通知', 'color' => '#4a5077'), 'keyword1' => array('value' => '推荐奖励', 'color' => '#4a5077'), 'keyword2' => array('value' => $subtext, 'color' => '#4a5077'), 'keyword3' => array('value' => date('Y-m-d H:i:s'), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '谢谢您对我们的支持！', 'color' => '#4a5077') ), '');
				}
				else 
				{
			...
			if (!(empty($poster['entrytext']))) 
			{
				...
				if (!(empty($poster['templateid']))) 
				{
					m('message')->sendTplNotice($openid, $poster['templateid'], array( 'first' => array('value' => '关注奖励到账通知', 'color' => '#4a5077'), 'keyword1' => array('value' => '关注奖励', 'color' => '#4a5077'), 'keyword2' => array('value' => $entrytext, 'color' => '#4a5077'), 'keyword3' => array('value' => date('Y-m-d H:i:s'), 'color' => '#4a5077'), 'remark' => array('value' => "\r\n" . '谢谢您对我们的支持！', 'color' => '#4a5077') ), '');
				}
				else 
				{
