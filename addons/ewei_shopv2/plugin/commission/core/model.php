...
if (!(class_exists('CommissionModel'))) 
{
		...
		public function checkAgent($openid = '') 
		{
			...
			if ($parent_is_agent) 
			{
				if ($parent['id'] != $member['agentid']) 
				{
					...
					{
						if (p('task') && empty($member['agentid'])) 
						{
			...
			if ($parent_is_agent && ($member['id'] != $parent['id'])) 
			{
    ...
    public function upgradeLevelByCommissionOK($openid)
    {
		...
		public function sendMessage($openid = '', $data = array(), $message_type = '') 
		{
			...
			if (($message_type == TM_COMMISSION_AGENT_NEW) && empty($usernotice['commission_agent_new'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $data['nickname'] . '，您新增了一个下级' . $data['nickname'], 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '新增下级通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您新增了一个下级' . $data['nickname'], 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '新增下级通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_agent_newtitle'])) ? $tm['commission_agent_newtitle'] : '恭喜您新增下级成员'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
			...
			else if (($message_type == TM_COMMISSION_ORDER_PAY) && empty($usernotice['commission_order_pay'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的下级' . $data['nickname'] . '已付款', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '下级付款通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的下级' . $data['nickname'] . '已经成功付款', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $data['nickname']);
					$datas[] = array('name' => '下级昵称', 'value' => $data['nickname']);
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '下级付款通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_order_paytitle'])) ? $tm['commission_order_paytitle'] : '您有下级付款了')), 'keyword3' => array('value' => $message) );
			...
			else if (($message_type == TM_COMMISSION_ORDER_FINISH) && empty($usernotice['commission_order_finish'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的下级' . $data['nickname'] . '已确认收货', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '下级收货通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的下级' . $data['nickname'] . '已经确认收货', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '下级确认收货通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_order_finishtitle'])) ? $tm['commission_order_finishtitle'] : '您有下级确认收货了'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
			...
			else if (($message_type == TM_COMMISSION_APPLY) && empty($usernotice['commission_apply'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['commission'] . '提现申请已提交', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '提现申请提交通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现申请已提交', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '提现申请提交通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_applytitle'])) ? $tm['commission_applytitle'] : '您的提现申请已经提交'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
			...
			else if (($message_type == TM_COMMISSION_CHECK) && empty($usernotice['commission_check'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['commission'] . '提现申请已审核通过', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '提现申请审核通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现申请审核完成', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
					$datas[] = array('name' => '时间', 'value' => $time);
					$datas[] = array('name' => '金额', 'value' => $data['commission']);
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '提现申请审核完成通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_checktitle'])) ? $tm['commission_checktitle'] : '您的提现申请已完成审核'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
			...
			else if (($message_type == TM_COMMISSION_PAY) && empty($usernotice['commission_pay'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，您的' . $set['texts']['commission1'] . '打款成功', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => $set['texts']['commission1'] . '打款通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现已打款成功', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
					$datas[] = array('name' => '时间', 'value' => $time);
					$datas[] = array('name' => '金额', 'value' => $data['commission']);
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '佣金打款通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_paytitle'])) ? $tm['commission_paytitle'] : '您的佣金已打款'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
			...
			else if (($message_type == TM_COMMISSION_UPGRADE) && empty($usernotice['commission_upgrade'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您成为' . $data['newlevel']['levelname'] . $set['texts']['agent'], 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => $set['texts']['agent'] . '等级升级通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '您的分销商等级从' . $data['oldlevel']['levelname'] . '升级为' . $data['oldlevel']['levelname'] . '特此通知!', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
					$datas[] = array('name' => '时间', 'value' => $time);
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '分销商等级升级通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_upgradetitle'])) ? $tm['commission_upgradetitle'] : '恭喜您升级了'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
			...
			else if (($message_type == TM_COMMISSION_BECOME) && empty($usernotice['commission_become'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的' . $member['nickname'] . '，恭喜您' . $set['texts']['become'], 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '成为' . $set['texts']['agent'] . '通知', 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '成为分销商通知', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $openid;
					$datas[] = array('name' => '昵称', 'value' => $data['nickname']);
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '成为分销商通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_becometitle'])) ? $tm['commission_becometitle'] : '恭喜您成为分销商'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#73a68d') );
					return $this->sendNotice($openid, $tm, 'commission_become_advanced', $data, $member, $msg);
				}
			}
			else if (($message_type == TM_COMMISSION_APPLYMONEY) && empty($usernotice['commission_applymoney'])) 
			{
				if ($tm['is_advanced']) 
				{
					...
					$message = array( 'first' => array('value' => '亲爱的管理员您有一条新的' . $set['texts']['commission'] . '提现申请', 'color' => '#ff0000'), 'keyword1' => array('title' => '业务类型', 'value' => '佣金提现', 'color' => '#000000'), 'keyword2' => array('title' => '业务状态', 'value' => '商户名称:' . $member['nickname'], 'color' => '#000000'), 'keyword3' => array('title' => '业务内容', 'value' => '佣金提现:' . $data['commission'] . '元', 'color' => '#000000'), 'remark' => array('value' => "\n" . '感谢您的支持', 'color' => '#000000') );
					$toopenid = $tm['openid'];
					$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
					$datas[] = array('name' => '时间', 'value' => $time);
					$datas[] = array('name' => '金额', 'value' => $data['commission']);
				...
				else 
				{
					...
					$msg = array( 'keyword1' => array('value' => '分销商提现通知', 'color' => '#73a68d'), 'keyword2' => array('value' => (!(empty($tm['commission_applymoneytitle'])) ? $tm['commission_applymoneytitle'] : '您有分销商申请提现了'), 'color' => '#73a68d'), 'keyword3' => array('value' => $message, 'color' => '#000000') );
		...
		public function saveRelation($id, $pid, $level = 1) 
		{
			$level = max($level, 1);
			if ($level == 1) 
			{
			...
			$parent = pdo_fetch('select id,uniacid,agentid from ' . tablename('ewei_shop_member') . ' where id = :id and id!=agentid', array(':id' => $pid));
			if (!(empty($parent))) 
			{
				...
				return $this->saveRelation($id, $parent['agentid'], $level);
			}
			return true;
		}
		public function delRelation($id = 0) 
		{
			...
			if (!(empty($parent))) 
			{
				foreach ($parent as $p ) 
				{
					pdo_delete('ewei_shop_commission_relation', array('id' => $p['id'], 'level' => $p['level']));
				}
			}
