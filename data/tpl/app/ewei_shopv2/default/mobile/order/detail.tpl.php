			...
			<?php  if(!empty($address)) { ?>
				<div class="fui-list-group noborder" style="display: block;">
					...
					<?php  } else { ?>
						...
						<?php  if($order['status'] > 0 && $order['sendtype']>0 && $order_goods  &&$order['city_express_state']==0) { ?>
				...
				<?php  if(is_array($goods)) { foreach($goods as $g) { ?>
					<a class="fui-list" href="<?php  if(empty($order['isnewstore'])) { ?><?php  echo mobileUrl('goods/detail',array('id'=>$g['goodsid']))?><?php  } else { ?><?php  echo mobileUrl('newstore/goods/detail',array('id'=>$g['goodsid'],'storeid'=>$order['storeid']))?><?php  } ?>">
						...
						<div class="fui-list-inner">
							...
							<?php  if(!empty($g['optionid'])) { ?><div class="subtitle"><?php  if(!empty($sortStr)) { ?><?php  echo $sortStr;?><?php  } else { ?><?php  echo $g['optiontitle'];?><?php  } ?></div><?php  } ?>
							...
							<a href="<?php  echo mobileUrl('member/fullback')?>"  class="fui-cell">
								...
								<div class="fui-cell-remark">
									...
									<?php  if($g['fullbackgoods']['type']>0) { ?>
										<?php  m('sale')->getFullBackText(true)?>  <?php  echo price_format($g['fullbackgoods']['minallfullbackallratio'],2)?>%  ， <?php  echo price_format($g['fullbackgoods']['fullbackratio'],2)?>% /天，共  <?php  echo $g['fullbackgoods']['day'];?>  天
									<?php  } else { ?>
										<?php  m('sale')->getFullBackText(true)?> &yen;<?php  echo price_format($g['fullbackgoods']['minallfullbackallprice'],2)?>，&yen;<?php  echo price_format($g['fullbackgoods']['fullbackprice'],2)?>/天，共 <?php  echo $g['fullbackgoods']['day'];?> 天
									<?php  } ?>
								</div>
							</a>
						</div>
				...
				<div class="fui-according-content">
					<div class="content-block">
						<div class="fui-cell-group notop store-container">
							...
							<a href="<?php  if(empty($item['merchid'])) { ?><?php  echo mobileUrl('store/detail',array('id'=>$item['id']))?><?php  } else { ?><?php  echo mobileUrl('store/detail',array('id'=>$item['id'],'merchid'=>$item['merchid']))?><?php  } ?>" class="fui-cell">
								<div class="fui-cell-icon">
									<i class="icon icon-locationfill"></i>
								</div>
								<div class="fui-cell-info">
