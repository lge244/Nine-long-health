		...
		<div style="overflow: hidden;height: 7.5rem;position: relative;background: #fff">
			<div class="headinfo" style="z-index:100;border: none;">
				...
				<div class="child">
					...
					<?php  if(empty($_W['shopset']['trade']['closerecharge'])) { ?><a href="<?php  echo mobileUrl('member/recharge')?>"><div class="btn">提现</div></a><?php  } ?>
				</div>
	...
	<div class="fui-cell-group fui-cell-click" style="margin-top: 0">
		...
		<div class="fui-icon-group selecter <?php  if($check_cycelbuy) { ?>col-5<?php  } else { ?>col-4<?php  } ?>">
			...
			<a class="fui-icon-col external" href="<?php  echo mobileUrl('order',array('status'=>4))?>">
				...
				<a class="fui-icon-col external before" <?php  if($_W['ewei_shopv2_member']['level'] == 0) { ?> onclick="alert('需要等级达到一级以上才可以邀请好友')" <?php  } else { ?> href="<?php  echo mobileUrl('member/share')?> <?php  } ?>">
