...
<div class="fui-page">
    ...
    <div class="fui-content">
        ...
        <?php  if(empty($type)) { ?>
        <div class="btn" id="res">立即注册</div>
        <?php  } else { ?>
        <div class="btn" id="btnSubmit">立即找回</div>
        <?php  } ?>
        <div class="text">
        ...
        <script language='javascript'>
           ...
           require(['biz/member/account'], function (modal) {
            ...
            $('#res').click(function () {
                ...
                var pwd = $('#pwd').val();
              var uid = $('#uid').val();
                $.post("<?php  echo mobileUrl('account/res')?>",{
                  "uid":uid,
                    "mobile":mobile,
                    ...
                    if (res.code == 0){
                        alert(res.msg);
                         if (uid == '') {
                            ...
                            window.location.replace("http://jiu.ahlzzn.com/app/index.php?i=2&c=entry&m=ewei_shopv2&do=mobile&r=download");
                        }
                    }else{
                        alert(res.msg);
                    }
