        ...
        <div class="fui-goods-group <%style.liststyle%>" style="background: <%style.background%>;">
            ...
            <div class="detail">
                ...
                <%/if%>
                        ...
                        <%if params.saleout>-1%>
                            <%if params.saleout==0%><div class="salez diy" style="background-image: url('<?php  echo tomedia($_W['shopset']['shop']['saleout'])?>'); "></div><%/if%>
...
<script type="text/html" id="tpl_show_memberc">
    <div class="drag" data-itemid="<%itemid%>">
        ...
        <%/if%>
        <%if params.style=='default3'%>
        <div class="headinfo commission style3" style="background-color: <%style.background%>; border-top: 0;">
                ...
                <div class="fui-list">
                    ...
                    <div class="fui-list-info" style="width: 12rem;">
                        ...
                        <%if params.hideup==0 || !params.hideup%>
                            <div class="text" style="color: <%style.textcolor%>;">推荐人: 总店</div>
                        <%/if%>
                        <div class="subtitle" style="color: <%style.textlight%>; border-color: <%style.textlight%>;">分销商等级</div>
    </div>
                </div>
                <div class="setbtn"><i class="icon <%params.seticon%>"></i></div>
            </div>
...
<script type="text/html" id="tpl_show_commission_block">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="userblock commission" style="background: <%style.background%>;">
            <div class="line total new" style="background: <%style.background%>;">
                <div class="num" style="color: <%style.pricecolor%>;">0.00</div>
                <div class="title" style="color: <%style.textcolor%>;">成功提现佣金(元)</div>
            </div>
            <div class="line usable new" style="background: <%style.background%>;">
                <div class="text">
                    <div class="num" style="color: <%style.pricecolor%>;">0.00</div>
                    <div class="title"style="color: <%style.textcolor%>;">可提现佣金(元)</div>
                </div>
                <div class="btn btn-warning disabled" style="padding-top: 0.4rem; background: <%style.btncolor%> !important;">佣金领取</div>
            </div>
        </div>
    </div>
</script>

<script type="text/html" id="tpl_show_commission_sharecode">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-cell-group" style="background: <%style.background%>;">
            <div class="fui-cell" style="height: 57px;">
                <div class="fui-cell-icon">
                    <i class="icon <%params.iconclass%>" style="color: <%style.iconcolor%>;"></i>
                </div>
                <div class="fui-cell-text" style="color: <%style.textcolor%>;">我的邀请码：10000</div>
            </div>
        </div>
    </div>
</script>
...
<script type="text/html" id="tpl_show_blockgroup">
    <div class="drag" data-itemid="<%itemid%>">
        <div class="fui-block-group col-<%params.rownum%> <%params.newstyle==1?'new':''%>" style="margin-top:0; overflow: hidden; background-color: <%style.background%>;">
            <%each data as item%>
            <div class="fui-block-child <%params.newstyle==1?'new':''%>" style="background-color: <%style.background%>;">
                ...
                <div class="title" style="color: <%item.textcolor%>;"><%item.text%></div>
                        <%if item.tipnum%>
                        <div class=""><span style="color: <%style.tipcolor%>"><%item.tipnum%></span> <%item.tiptext%></div>
                        <%/if%>
                    </div>
                <%else%>
                    <div class="title" style="color: <%item.textcolor%>;"><%item.text%></div>
