	...
	<div class="modal-content">
		...
		<div class="modal-body">
			<ul class="nav nav-tabs" id="selectUrlTab">
				...
				<?php  if($platform=='wxapp' && $type != 'topmenu' && $type != 'topmenu_data') { ?>
				...
				<?php  } ?>
				<?php  if(p('quick') && !$platform && $type != 'topmenu' && $type != 'topmenu_data') { ?>
			...
			<div class="tab-content ">
				...
				<div class="tab-pane" id="sut_quick">
					...
					<div class="line">
						<nav title="选择" class="btn btn-default btn-sm" data-href="/pages/quickbuy/quickbuy/shop_index/shop_index?id=<?php  echo $item['id'];?>">选择</nav>
