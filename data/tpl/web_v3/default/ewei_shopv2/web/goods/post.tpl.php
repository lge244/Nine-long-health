    ...
    <div class="tabs-container tab-goods">
        <div class="tabs-left">
            <ul class="nav nav-tabs" id="myTab">
				...
				<li <?php  if($item['type'] != 5) { ?>style="display:none;"<?php  } ?>   class="showverifygoods <?php  if($_GPC['tab']=='verifygoods') { ?>active<?php  } ?>" ><a href="#tab_verifygoods">记次/时核销</a></li>
				<?php  if(com('wxcard')) { ?>
				<li <?php  if($item['type'] != 5) { ?>style="display:none;"<?php  } ?>   class="showverifygoodscard <?php  if($_GPC['tab']=='verifygoodscard') { ?> active<?php  } ?>" ><a href="#tab_verifygoodscard">微信会员卡设置</a></li>
				<?php  } ?>
            </ul>
