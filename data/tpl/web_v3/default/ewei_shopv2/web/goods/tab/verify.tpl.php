...
<div class="col-sm-9 col-xs-12">
    <?php if( ce('goods' ,$item) ) { ?>
    <label class="radio-inline">
        <input type="radio" name='isforceverifystore' value="0" <?php  if(empty($item['isforceverifystore'])) { ?>checked<?php  } ?> /> 否
    </label>
    <label class="radio-inline">
        <input type="radio" name='isforceverifystore' value="1" <?php  if($item['isforceverifystore']==1) { ?>checked<?php  } ?> /> 是
    </label>
