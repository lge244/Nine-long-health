        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="recharge_info">
                    <div>
                        <label class="pull-left" style="margin-right: 25px">用户</label>
                        <div class="pull-left">
                ...
                <div class="tabs-container">
                    ...
                    <div class="tabs">
                        <ul class="nav nav-tabs">
                            <li <?php  if($type=='credit1') { ?>class="active"<?php  } ?>><a data-toggle="tab" href="#tab-1" data-rechargetype="credit1" aria-expanded="true"> 充值佣金</a></li>
                        </ul>
                        <div class="tab-content ">
                            <div id="tab-1" class="tab-pane active">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">当前佣金</label>
                                    <div class="col-sm-9 col-xs-12">
                                        <div class="form-control-static"><?php  echo $profile['brokerage'];?></div>
                                    </div>
                                </div>
            ...
            <button class="btn btn-primary btn-submit" type="submit">确认充值<?php  if($type=='credit1') { ?>积分<?php  } else { ?>余额<?php  } ?></button>
