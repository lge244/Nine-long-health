                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="">
                            ...
                            <li class="text"><span class="col-sm">平台单号：</span><span class="text-default"><?php  echo $item['transid'];?></span></li>
                            <?php  } ?>
                            <?php  if(!empty($coupon)) { ?>
                            <li class="text">
    ...
    "><i class='icow icow-help' style="font-size: 13px;color: #2f3434;margin-left: -3px"></i></a>
                            ...
                            <?php  $invoice_info = m('sale')->parseInvoiceInfo($item['invoicename'])?>
                                ...
                                <?php  if($invoice_info['title']) { ?>
                                    <li class="text">
                                        ...
                                        <a class="<?php  if($item['invoice_img']) { ?>text-success<?php  } else { ?>text-danger<?php  } ?>"
                                           href="<?php  echo webUrl('order.op.upload_invoice',array('order_id'=>$item['id']));?>"
                                           data-toggle="ajaxModal"> <?php  if($item['invoice_img']) { ?>查看已上传的电子发票<?php  } else { ?>需要上传电子发票<?php  } ?></a>
                                        <?php  } ?>
                                    </li>
                                    <li class="text">
                                ...
                                <li class="text">
                                    ...
                                    <span class="text-default">
                                        ...
                                        <?php  } else { ?><?php  echo $item['invoicename'];?><?php  } ?></span>
                                </li>
            ...
            <div class="distribution col-sm-4 col-md-3">
                    ...
                    <div>
                        ...
                        <ul>
                            <li class="text">
                                <span style="display:inline-block;width: 45px;">姓名：</span>
                                <span class="text-primary" >
                                                <a href="<?php  echo webUrl('member/list/detail',array('id'=>$heads['id']))?>" target='_blank' class="text-primary"> <?php  if(empty($heads['realname'])) { ?>未填写<?php  } else { ?><?php  echo $heads['realname'];?><?php  } ?></a>
                                                <a data-toggle='popover' data-trigger='hover'  data-html='true' data-placement='right' data-content="<table style='width:100%;'>

                                <tr>
                                    <td  style='border:none;text-align:right;' colspan='2'><img src='<?php  echo tomedia($heads['avatar'])?>' style='width:100px;height:100px;padding:1px;border:1px solid #ccc' /></td>
                                </tr>
                                 <tr>
                                    <td  style='border:none;text-align:right;'>ID：</td>
                                ...
                                <tr>
                                    ...
                                    <td  style='border:none;text-align:right;'> <?php  if(empty($heads['mobile'])) { ?>未填写<?php  } else { ?><?php  echo $heads['mobile'];?><?php  } ?></td>
                                </tr>
                                <tr>
                                    <td  style='border:none;text-align:right;'>微信号：</td>
                ...
                "><i class='icow icow-help' style="font-size: 13px;color: #2f3434"></i></a>
                            ...
                            <li class="text"><span style="display:inline-block;width: 50px;">手机号：</span><span class="text-default"><?php  echo $heads['mobile'];?></span></li>
                            <li class="text"><span style="display:inline-block;width: 50px;">分红：</span><span class='text-default'><?php  echo $dividend_price;?></span></li>
                        </ul>
                    </div>
                <?php  } ?>
                <!----分红结束-------->
