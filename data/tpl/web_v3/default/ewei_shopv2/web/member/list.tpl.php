                    ...
                    <tbody>
                        ...
                        <?php  } ?> <br/>
                            ...
                            <td>
                               ...
                               <span>佣金: <span class="text-warning"><?php  echo price_format($row['brokerage'],2)?> </span></span></td> <td>

                               <span>推荐人数: <span class="text-warning"><?php  echo price_format($row['invite'],2)?> </span></span></td>
