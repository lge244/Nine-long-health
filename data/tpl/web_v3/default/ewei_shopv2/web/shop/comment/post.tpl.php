...
<div class="page-content">
    ...
    <form id="dataform" action="" method="post" class="form-horizontal form-validate" >
        ...
        <div class="form-group">
            <label class="col-lg control-label">订单号</label>
            <div class="col-sm-9 col-xs-12">
                <div class='form-control-static'><?php  echo $order['ordersn'];?></div>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg control-label">评价商品</label>
            <div class="col-sm-9 col-xs-12">
                ...
                <span id="goodsthumb" class='help-block' <?php  if(empty($goods)) { ?>style="display:none" <?php  } ?>>
                    <img style="width:100px;height:100px;border:1px solid #ccc;padding:1px" src="<?php  echo tomedia($goods['thumb'])?>"  onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'"/>
                </span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg control-label">评价者</label>
            <div class="col-sm-9 col-xs-12">
                ...
                <span id="nicknamethumb" class='help-block'>
                    <img style="width:100px;height:100px;border:1px solid #ccc;padding:1px" src="<?php  echo tomedia($item['headimgurl'])?>" onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'"/>
                </span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-lg control-label">评分等级</label>
            <div class="col-sm-9 col-xs-12">
        ...
        <div class="form-group">
            <label class="col-lg control-label"><span style='color:red'>*</span> 首次评价</label>
            <div class="col-sm-9 col-xs-12">
                        ...
                        <div class="multi-item" style="min-height: 100px; height: auto; max-width: none; max-height: none;">
                            <a href='<?php  echo tomedia($img)?>' target='_blank'>
                                <img class="img-responsive img-thumbnail" src='<?php  echo tomedia($img)?>'
                                     onerror="this.src='../addons/ewei_shopv2/static/images/nopic.png'; this.title='图片未找到.'">
                            </a>
                        </div>
                    <?php  } } ?>
                </div>
        ...
        <?php  if($type == 1) { ?>
            <div class="form-group">
                <label class="col-lg control-label">首次评价审核状态 </label>
                <div class="col-sm-9 col-xs-12">
                    <label class='radio-inline'><input type='radio' name='checked' value='0' <?php  if(empty($item['checked'])) { ?>checked<?php  } ?>/>
                        通过</label>
                    <label class='radio-inline'><input type='radio' name='checked' value='2' <?php  if($item['checked']=='2') { ?>checked<?php  } ?>
                        /> 不通过</label>
                    <label class='radio-inline'><input type='radio' name='checked' value='1' <?php  if($item['checked']=='1') { ?>checked<?php  } ?>
                        /> 审核中</label>
                </div>
            </div>
            <br>
        ...
        <?php  if($type == 1 && !empty($item['append_content'])) { ?>
            <div class="form-group">
                <label class="col-lg control-label">追加评价审核状态 </label>
                <div class="col-sm-9 col-xs-12">
