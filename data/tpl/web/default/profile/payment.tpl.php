					...
					<div class="we7-form">
						<div class="form-group">
							...
							<div class="form-controls col-sm-10">
								...
								<?php  if(!empty($proxy_wechatpay_account['service'])) { ?>
		...
		<tr>
			...
			<td colspan="2">
				<label>
					...
					<div ng-class="paysetting[config.paytype].recharge_switch === true ? 'switch switchOn' : 'switch'"></div>
				</label>
			</td>
		...
		<tr>
			...
			<td colspan="2">
				<label>
					...
					<div ng-class="paysetting[config.paytype].pay_switch === true ? 'switch switchOn' : 'switch'"></div>
				</label>
			</td>
			<td colspan="2"></td>
		</tr>
