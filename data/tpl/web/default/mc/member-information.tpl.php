...
<div class="btn-group we7-btn-group">
	...
	<a href="<?php  echo url('mc/member/member_credits', array('uid' => $uid))?>" class="btn <?php  if($do == 'member_credits') { ?>active<?php  } ?>">积分/余额</a>
...
<div class="main">
	<form action="" class="we7-form form" method="post" enctype="multipart/form-data">
		...
		<table class="table we7-table table-hover table-form">
			...
			<col width="100px">
			<tr>
				<th class="text-left" colspan="3">会员积分/余额操作</th>
			</tr>
			<tr>
				<td class="table-label">积分</td>
				<td><?php  echo $credits['credit1'];?></td>
				<td class="text-right">
					<div class="link-group"><a href="javascript:;" title="积分" class="modal-trade-credit1" data-type="credit1" data-uid="<?php  echo $uid;?>">修改</a></div>
				</td>
			</tr>
			<tr>
				<td class="table-label">余额</td>
				<td><?php  echo $credits['credit2'];?></td>
				<td class="text-right">
					<div class="link-group"><a href="javascript:;" title="余额" class="modal-trade-credit2" data-type="credit2" data-uid="<?php  echo $uid;?>">修改</a></div>
				</td>
			</tr>
		</table>
		<table class="table we7-table table-hover table-form">
			...
			<tr>
				<th colspan="6">
					<div class="btn-group we7-btn-group">
						<a href="<?php  echo url('mc/member/member_credits', array('uid' => $uid, 'type' => 'credit1'))?>" class="btn <?php  if($type == 'credit1') { ?>active<?php  } ?>">积分记录</a>
						<a href="<?php  echo url('mc/member/member_credits', array('uid' => $uid, 'type' => 'credit2'))?>" class="btn <?php  if($type == 'credit2') { ?>active<?php  } ?>">余额记录</a>
					</div>
				</th>
			</tr>
			<tr>
			...
			<?php  if(!empty($records)) { ?>
				...
				<tr>
					<td class="text-center"><?php  if($record['credittype'] == 'credit2') { ?>余额<?php  } else { ?>积分<?php  } ?></td>
